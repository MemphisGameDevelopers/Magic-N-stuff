...
inline half4 LightingTreeLeaf (LeafSurfaceOutput s, half3 lightDir, half3 viewDir, half atten)
{
	...
	// Groundlighting should only affect directional lights...
	// For directional lights, apply less shadow attenuation based on shadow strength parameter.
	// add ground lighting
	#if defined(DIRECTIONAL) || defined(DIRECTIONAL_COOKIE)
	c.rgb = c.rgb * _LightColor0.rgb * s.GroundLighting + spec * _LightColor0.rgb * s.GroundLighting;
