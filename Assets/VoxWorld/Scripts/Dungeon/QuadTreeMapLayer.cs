...
public class QuadTreeMapLayer
{
		...
		// Children
		public QuadTreeMapLayer parent;
		public QuadTreeMapLayer northWest;
		public QuadTreeMapLayer northEast;
		public QuadTreeMapLayer southWest;
		public QuadTreeMapLayer southEast;
		...
		// Constructor
		public QuadTreeMapLayer (AABB _aabb, Dungeon inDungeon)
		{
				boundary = _aabb;
				dungeon = inDungeon;
	 ...
	 */
		...
		XY GetAnyRoomCenter ()
		{
				...
				case 1:
						if (northWest != null)
								return northWest.GetAnyRoomCenter ();
						else
								return GetAnyRoomCenter ();
				case 2:
						if (northEast != null)
								return northEast.GetAnyRoomCenter ();
						else
								return GetAnyRoomCenter ();
				case 3:
						if (southWest != null)
								return southWest.GetAnyRoomCenter ();
						else
								return GetAnyRoomCenter ();
				case 4:
						if (southEast != null)
								return southEast.GetAnyRoomCenter ();
						else
								return GetAnyRoomCenter ();
				}	
				return null;
...
//	}
		...
		public bool HasChildrenWithRoom ()
		{
				if (!HasChildren ())
						return false;
				if (northWest.room != null && northEast.room != null && southWest.room != null && southEast.room != null)
						return true;
				return false;
		}
